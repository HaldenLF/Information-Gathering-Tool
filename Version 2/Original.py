# Scrapped and project was replanned to better suit my goals and vision for this project
...
# # Removed due to unreliable results
# 
...
if __name__ == "__main__":
    ...
    if userChoice.lower() == "5" or "1-4 scan" or "scan all":
        portScan(userTarget)
        dnsScan(userTarget)
        whoisScan(userTarget)
        subdomainScan(userTarget)

    if userChoice.lower() == "6" or "sitemap" or "site map":
        siteMap(userTarget)
